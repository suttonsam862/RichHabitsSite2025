    ...
    try {
      ...
      if (eventId === 2) {
        ...
        const nationalChampCampEvent = {
          ...
          description: "An intensive three-day wrestling camp featuring elite coaching from Penn State NCAA champions. This camp combines technical instruction, live wrestling, and competitive training in a high-energy environment. Limited to 200 wrestlers.",
          price: "$349 full camp or $175 per day",
          shopifyProductId: "national-champ-camp",
          image: "/assets/LongSitePhotovegas.png",
          maxParticipants: 200,
