...
export function Footer() {
  ...
  return (
    <footer className="bg-gray-100 border-t border-gray-200">
      {/* Subtle sky accent line at top */}
      <div className="h-px w-full bg-sky-200 opacity-30"></div>
      
      <div className="container mx-auto px-6 py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            <h3 className="text-2xl mb-6" style={{ fontFamily: "'Bodoni FLF', serif" }}>
              Rich Habits
            </h3>
            <p className="text-gray-600 mb-6" style={{ fontFamily: "'Didact Gothic', sans-serif" }}>
              Premium athletic apparel for high-performing athletes who demand quality in every detail.
            </p>
            <div className="flex space-x-5">
              {/* Social links with sky blue hover effect */}
              {[
                ...
                <motion.a 
                  ...
                  whileHover={{ color: '#0369a1', scale: 1.1 }}
          ...
          <div className="md:col-span-1">
            <h3 className="text-lg mb-6 font-medium" style={{ fontFamily: "'Sanchez', serif" }}>
              Navigation
            </h3>
            ...
            <ul className="space-y-4">
              <li>
                <p className="text-gray-600" style={{ fontFamily: "'Didact Gothic', sans-serif" }}>
                  <span className="font-medium">Email:</span> admin@rich-habits.com
                </p>
              </li>
              <li>
                <p className="text-gray-600" style={{ fontFamily: "'Didact Gothic', sans-serif" }}>
              ...
              <li>
                <p className="text-gray-600" style={{ fontFamily: "'Didact Gothic', sans-serif" }}>
                  <span className="font-medium">Location:</span> Birmingham, AL
                </p>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-gray-500">
          <p style={{ fontFamily: "'Arial', sans-serif" }}>
            &copy; {currentYear} Rich Habits. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
