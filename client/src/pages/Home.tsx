      ...
      <section className="w-full min-h-[95vh] bg-gray-100 flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-gray-900">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 tracking-wide text-gray-700 subtitle-font">
      ...
      <section className="py-24 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-12 leading-relaxed max-w-3xl mx-auto text-gray-700 subtitle-font">
