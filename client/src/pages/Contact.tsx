    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Contact Rich Habits Wrestling</h1>
          <p className="text-lg text-gray-600">Get in touch with our team for camps, custom apparel, or general inquiries.</p>
        </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-600">info@richhabits.com</p>
              </div>
              <div>
